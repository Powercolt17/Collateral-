    ...
    return `
        <style>
            ...
            .rv-mech-num {
                ...
                font-family: var(--font-content), 'Helvetica Neue', sans-serif;
            }
            .rv-mech-label {
            ...
            .rv-modal-title {
                font-family: var(--font-content); font-size: 24px; font-weight: 600; color: #211B12;
            ...
            .rv-dur-pill {
                ...
                background: #F5EDDA; font-family: var(--font-data);
            ...
            .rv-btn-submit {
                ...
                border-radius: 8px; font-family: var(--font-data);
            ...
            <div class="rv-modal">
                ...
                <div class="rv-form-group">
                    ...
                    <div class="rv-challenge-type-toggle" id="rv-challenge-type" style="display:flex;gap:0;border:1px solid rgba(70,55,35,.22);overflow:hidden;margin-bottom:8px;">
                        <button class="rv-type-btn active" data-type="direct" style="flex:1;padding:10px 16px;background:#1a1a1a;color:#fff;border:none;font-family:var(--font-data);font-size:10px;letter-spacing:0.08em;cursor:pointer;font-weight:700;text-transform:uppercase;transition:all 0.15s;">✉ Direct Challenge</button>
                        <button class="rv-type-btn" data-type="open" style="flex:1;padding:10px 16px;background: #F5EDDA;color:#666;border:none;border-left:1px solid rgba(70,55,35,.22);font-family:var(--font-data);font-size:10px;letter-spacing:0.08em;cursor:pointer;font-weight:700;text-transform:uppercase;transition:all 0.15s;">🌐 Open Challenge</button>
                    </div>
...
export async function initRivalry() {
    ...
    function renderCard(r) {
        ...
        const challGrowth = isPending
            ? '<span class="rv-player-growth awaiting" style="font-family:var(--font-data);letter-spacing:0.1em;text-transform:uppercase;">FORMING</span>'
            : isAccepted
            ? (r.challFunded
                ? '<span class="rv-player-growth" style="font-family:var(--font-data);letter-spacing:0.1em;text-transform:uppercase;color:#16a34a;font-size:13px;">✓ FUNDED</span>'
                : '<span class="rv-player-growth awaiting" style="font-family:var(--font-data);letter-spacing:0.1em;text-transform:uppercase;color:#d97706;font-size:12px;">FUND REQUIRED</span>')
        ...
        if (isPending) {
            ...
            if (myFunded) {
                actionsHtml = `<div class="rv-card-actions"><div style="flex:1;padding:10px 16px;background:#f8f8f8;color:#999;text-align:center;font-family:var(--font-data);font-size:10px;font-weight:700;letter-spacing:0.08em;border:1px solid rgba(70,55,35,.18);">WAITING FOR OPPONENT</div></div>`;
            } else {
        ...
        return `
            <div class="rv-card" data-status="${r.status}" data-id="${r.id}" ${resultAttr}>
                <div class="rv-card-inner">
                    ...
                    <div class="rv-card-metric">${r.metric} <span style="color:#ccc;font-size:10px;font-family:var(--font-data);margin-left:6px;">ID:${shortId}</span></div>
                    <div class="rv-versus">
                        <div class="rv-player">
    ...
    function renderGrid() {
        ...
        if (filtered.length === 0) {
            grid.innerHTML = `<div style="grid-column:1/-1;text-align:center;padding:60px 20px;">
                <div style="font-family:var(--font-data);font-size:11px;font-weight:700;letter-spacing:0.12em;color:#ccc;text-transform:uppercase;margin-bottom:12px;">No rivalries found</div>
    ...
    function renderFeatured() {
        ...
        const challGrowth = hot.status === 'pending'
            ? '<span class="rv-featured-growth" style="color:#ccc;font-size:16px;font-family:var(--font-data);letter-spacing:0.1em;text-transform:uppercase;">FORMING</span>'
