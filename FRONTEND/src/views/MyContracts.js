...
/* THE SEAL — the struck-wax photograph, not a circle with a letter on it.
 *
 * What was here was a flat #7C1D2B disc, a second disc for a rule and a cream C
 * on top. At 30px it read as a bullet. Wax is a photographed object — the gloss,
 * the uneven rim, the pressed grain — and it does not survive being approximated
 * in vector; that was tried and it looked like a blob.
 *
 * The asset is /wax-seal.png, 256px so it stays sharp at 2x and 3x on the 54px
 * it is drawn at. Its background was keyed out: the source shipped on a #F2E4D3
 * cream that is NOT this page's #F5EDDA, so dropped in as-is it showed as a
 * warm square patch on the card. The alpha was cut by flood-filling from the
 * borders inward — a straight colour threshold would have punched holes through
 * the pale specular highlights on the rim, which sit at #DCB0B1 and read as
